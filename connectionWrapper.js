// WebcastPushConnection moved to the /legacy subpath in tiktok-live-connector v2.x.
// It keeps the old (uniqueId, options) + event-name API this app was built against.
